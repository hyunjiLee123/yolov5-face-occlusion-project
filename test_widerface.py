...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_folder', default='./data/widerface/val_test/images/', type=str, help='dataset path')
    # parser.add_argument('--folder_pict', default='./data/widerface/val/wider_val.txt', type=str, help='folder_pict')
    # train: /home/user/yolov5-face/data/widerface/train  # 16551 images
    # val: /home/user/yolov5-face/data/widerface/val/images  # 16551 images
    ...
    with torch.no_grad():
        ...
        # PATH format of images & labels folder
            ./data/widerface/
                ...
                0--Parade_*_*_*.jpg
                0--Parade_*_*_*.txt
                1--Handshaking_*_*_*.jpg
                1--Handshaking_*_*_*.txt
                ...
                61--Street_Battle_*_*_*.jpg
                61--Street_Battle_*_*_*.txt
